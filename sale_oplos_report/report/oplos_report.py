...
class SaleOplosFakturReport(models.AbstractModel):
    _name = 'report.sale_oplos_report.report_faktur_pajak'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('sale_oplos_report.report_faktur_pajak', docargs)
